...
$FoldersArray = @(
  ...
  #
  (1,"$DROPBOX\CAM-best"              ,"$backupFolder\Dr-CAM-best"              ,"E:\Sync1Dr\CAM-best")              ,
  (1,"$DROPBOX\CAM-good"              ,"$backupFolder\Dr-CAM-good"              ,"E:\Sync1Dr\CAM-good")              ,
  (1,"$DROPBOX\CAT-Wellbeing"         ,"$backupFolder\Dr-CAT-Wellbeing"         ,"E:\Sync0Dr\CAT-Wellbeing")         ,
  (1,"$DROPBOX\COutThere"             ,"$backupFolder\Dr-COutThere"             ,"E:\Sync0Dr\COutThere")             ,
