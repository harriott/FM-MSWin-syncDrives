...
$FoldersArray = @(
  ...
  (1,"E:\Dropbox\JH\k-Copied"          ,"$backupFolder\Dr-JH-k-Copied"          ,"G:\k-Copied")                     ,
  (1,"E:\Dropbox\JH\k-Now"             ,"$backupFolder\Dr-JH-k-Now"             ,"G:\k-Now")                        ,
  (1,"E:\Dropbox\JH\k-Then0"           ,"$backupFolder\Dr-JH-k-Then0"           ,"G:\k-Then0")                      ,
  (1,"E:\Dropbox\JH\k-Then1"           ,"$backupFolder\Dr-JH-k-Then1"           ,"G:\k-Then1")                      ,
